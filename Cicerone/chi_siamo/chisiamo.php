...
<head>
    ...
    <title>chi_siamo_cicerone</title>
                ...
                <div class="container"><a class="navbar-brand" href="../index/index.php"
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../crea_attività/creaattività.php"
                                    style="font-family: Roboto, sans-serif;">Crea attività<i class="fa fa-plus"
                                        style="padding-left: 5px;"></i></a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../ricerca_attività/ricercaattività.php"
                            ...
                            <li class="dropdown nav-item"><a class="dropdown-toggle nav-link" data-toggle="dropdown"
                                ...
                                href="../profilo/profilo.php?id_registrazione=' . $_SESSION['id'] .'" style="font-family: Roboto, sans-serif;">Profilo<i class="fa fa-user"
                                    ...
                                    <a class="dropdown-item" role="presentation" href="../elenco_feedback/elencofeedback.php"
                                        style="font-family: Roboto, sans-serif;">Feedback<i class="fa fa-feed"
                                            style="padding-left: 5px;"></i></a><a class="dropdown-item"
                                        role="presentation" href="../log_out/logout.php" style="font-family: Roboto, sans-serif;">Log Out<i
