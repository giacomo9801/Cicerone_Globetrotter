        ...
        <div class="col text-center" style="background-color: rgba(245,245,245,0);"><i class="fa fa-user-o" style="font-size: 100px;"></i>
            <div class="row" style="padding-top: 30px;">
                ...
                <div class="col" style="margin-bottom: 10px;">
                    <h1 class="text-center" style="background-color: #6c757d;padding-top: 10px;padding-bottom: 10px;color: rgb(255,255,255);font-size: 40px;font-weight: bold;">
                        Nuovi dati</h1>
                    <div class="row">
                        <div class="col">
