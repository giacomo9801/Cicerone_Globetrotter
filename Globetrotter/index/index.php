...
<head>
    ...
    <title>index_globetrotter</title>
            ...
            <div class="container"><a class="navbar-brand" href="../index/index.php" style="font-size: 35px;filter: blur(0px);font-style: italic;">Cicerone</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav ml-auto">
                        ...
                        <li class="dropdown nav-item"><a class="dropdown-toggle nav-link text-center" data-toggle="dropdown" aria-expanded="false" href="../index/index.php" style="font-family: Roboto, sans-serif;"><strong><?php echo $_SESSION['nome']; ?></strong></a>
                        ...
                        <div class="card">
                            ...
                            <div class="collapse item-1" role="tabpanel" data-parent="#accordion-1">
                                <div class="card-body text-center">
                                    <p class="card-text">Cicerone vuol dire essere una persona con spiccate capacità
