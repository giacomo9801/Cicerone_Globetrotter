...
<head>
    ...
    <title>come_funziona_globetrotter</title>
...
<body class="text-center" style="margin-top: 0px;margin-bottom: -28px;font-family: 'Roboto' !important;">
        ...
        <div class="container"><a class="navbar-brand" href="#"
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="../index/index.php"><strong><?php echo $_SESSION['nome']; ?></strong><i
                    ...
                    <li class="dropdown nav-item"><a class="dropdown-toggle nav-link" data-toggle="dropdown"
                            aria-expanded="false" href="#">Nome</a>
    ...
    <h1 class="text-center"
        ...
        <br><strong>Globetrotter: ti piace parlare ma anche viaggiare?</strong><br><br></h1>
    ...
    <h1 style="margin-right: -8px;font-size: 36px;margin-left: 10px;"><i class="fa fa-circle-thin"
            style="font-size: 40px;margin-right: 0px;padding-right: 0px;"></i>&nbsp;Rilascia un feedback</h1>
    <h1 style="font-size: 26px;font-weight: normal;margin-left: 10px;">Fai sapere al Cicerone come è andata l'attività e
        quanto ti sei divertito!</h1>
    <div class="footer-clean" style="background-color: rgba(146,144,144,0.37);">
        <footer>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-sm-4 col-md-3 text-center item">
                        <ul></ul><a href="#" style="color: rgb(255,255,255);font-size: 22px;font-weight: bold;">Come
                            funziona</a>
                    </div>
                    <div class="col-sm-4 col-md-3 text-center item">
