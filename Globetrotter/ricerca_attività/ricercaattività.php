...
<head>
    ...
    <title>ricerca_attività_globetrotter</title>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-8">
                        <form class="card card-sm" action="../elenco_attività/elencoattività.php">
                            <div class="card-body row no-gutters align-items-center">
                                ...
                                <!--end of col-->
                                <div class="col">
                                    <input class="form-control form-control-lg form-control-borderless" required name="ricerca" type="search" placeholder="Ricerca in base al tuo luogo preferito
                                                                                                                                       ">
                                </div>
                                <!--end of col-->
                                <div class="col-auto">
                                    <button class="btn btn-lg btn-success" type="submit">RICERCA</button>
                                </div>
                                <!--end of col-->
                            </div>
                        </form>
                ...
                <div class="col">
                    <h1 class="text-center" style="font-size: 20px;">Ecco alcuni luoghi che puoi ricercare presenti nel
                        ...
                        <?php
                        #faccio uscire dei suggerimenti in base alle attività presenti sul db
                        $query = $cn->query("SELECT DISTINCT luogo from attivita where stato=1 LIMIT 4 ");
