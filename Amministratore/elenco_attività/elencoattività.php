...
<head>
    ...
    <title>elenco_attività_amministratore</title>
...
<body style="font-family: 'Roboto';">
    ...
    <div class="row">
        <div class="col">
            <h1 class="text-center" style="background-color: #5dd167;color: rgb(255,255,255);font-size: 30px;font-weight: bold;">Elenco
                completo attività&nbsp;</h1>
        </div>
    </div>


    <?php
    #codice php per visualizzare le attività con il pulsante di chiusura.
    #per la chiusura verrà utilizzato l'id dell'attività
    $q = mysqli_query($cn, "SELECT * FROM attivita where stato=1");
    $r = mysqli_num_rows($q);
    if ($r == false) {
        echo "<h3 style='color:Red' class='text-center'>Nessuna attività presente</h3>";
    } else {
        ?>

        <script type="text/javascript">
            function deletes(id) {
                a = confirm('Sei sicuro di voler chiudere questa attività ?')
                if (a) {
            ...
            <div class="col-sm-12">
                ...
                <table class="table table-bordered">
                    ...
                    while ($row = mysqli_fetch_assoc($q)) {
                        ...
                        echo "<td><a href='#' onclick='deletes($row[id_attivita])'>Chiudi attività</a></td>";
                        echo "</tr>";
                        $i++;
                    }
                    ?>
