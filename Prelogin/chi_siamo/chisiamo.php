...
<head>
    ...
    <title>chi_siamo_prelogin</title>
                ...
                <div class="container"><a class="navbar-brand" href="../index/index.php"
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../../Registrazione/registrazione.php">Registrati<i
                                        class="fa fa-search-plus" style="padding-left: 5px;font-size: 20px;"></i></a>
                            </li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="../../Login/login.php">Login<i
