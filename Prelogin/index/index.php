...
<body style="font-family: 'Roboto' !important;">
            ...
            <div class="container"><a class="navbar-brand" href="index.php"
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item" role="presentation"><a class="nav-link text-center" href="index.php">Home<i
                                    class=" fa fa-home" style="font-size: 20px;padding-left: 5px;"></i></a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-center" href="../../Registrazione/registrazione.php">Registrati<i
                                    class="fa fa-search-plus" style="padding-left: 5px;font-size: 20px;"></i></a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link text-center" href="../../Login/login.php">Login<i
                                    class="fa fa-user" style="padding-left: 5px;font-size: 20px;"></i></a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="highlight-blue"
        style="background-color: rgba(255,255,255,0);background-image: url(&quot;assets/img/sfondo_high.jpeg&quot;);background-repeat: no-repeat;background-size: cover;background-position: bottom;padding-top: 80px;">
        <div class="container">
            <div class="intro">
                <h2 class="text-center"
                    style="font-size: 40px;letter-spacing: 3px;line-height: 66px;font-weight: bold;font-family: Roboto, sans-serif;">
            ...
            <div class="buttons"><a class="btn btn-primary disabled" role="button" href="#">Ricerca attività</a></div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="intro">
                        ...
                        <p>Crea una nuova attività, fai conoscere chi sei e quali posti conosci!</p><a
                            class="btn btn-primary disabled" role="button" href="#">Crea attività</a>
                    </div>
                </div>
                <div class="col-sm-4">
    ...
    <div class="article-list">
        <div class="container" style="padding-top: 20px;">
            <div class="intro">
                <h2 class="text-center"
                    style="background-color: #5dd167;color: rgb(255,255,255);padding-bottom: 10px;padding-top: 10px;font-size: 30px;font-weight: bold;font-family: Roboto, sans-serif;">
                    3 cose su Cicerone che ti conquisteranno</h2>
            </div>
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item" data-bs-hover-animate="pulse"><a href="#"></a><i class="fa fa-users"
                ...
                <div class="col-sm-6 col-md-4 item" data-bs-hover-animate="pulse"><a href="#"></a><i
                        class="fa fa-calendar-check-o" style="font-size: 55px;"></i>
                ...
                <div class="col-sm-6 col-md-4 item" data-bs-hover-animate="pulse"><a href="#"></a><i class="fa fa-euro"
                        style="font-size: 55px;"></i>
    ...
    <div class="team-grid">
        <div class="container" style="margin-top: -70px;">
            <div class="intro">
                <h2 class="text-center"
                    style="background-color: #e3cece;padding-bottom: 40px;color: rgb(255,255,255);font-family: Roboto, sans-serif;font-weight: bold;">
                    Team </h2>
            </div>
                ...
                <div class="col-md-4 col-lg-3 item" data-aos="fade-right" data-aos-duration="850">
                    <div class="box" style="background-image: url(&quot;assets/img/foto_giacomo.jpg&quot;);">
                        <div class="cover">
                            ...
                            <div class="social"><a href="https://www.facebook.com/giacomocorcella981"><i
                                        class="fa fa-facebook-official"></i></a><a
                                    href="https://www.instagram.com/giacomo_c98/"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 item" data-aos="fade-down" data-aos-duration="850">
                    <div class="box" style="background-image: url(&quot;assets/img/foto_manu.jpg&quot;);">
                        <div class="cover">
                            ...
                            <p class="title">Developer</p>
                            <div class="social"><a href="https://www.facebook.com/emanuele.colonna.79"><i
                                        class="fa fa-facebook-official"></i></a><a
                                    href="https://www.instagram.com/emanuele_colonna/"><i
                ...
                <div class="col-md-4 col-lg-3 item" data-aos="fade-up" data-aos-duration="850">
                    <div class="box" style="background-image: url(&quot;assets/img/foto_fuccilli.jpg&quot;);">
                        <div class="cover">
                            ...
                            <p class="title">Developer</p>
                            <div class="social"><a href="https://www.facebook.com/francesco.fuccilli"><i
                                        class="fa fa-facebook-official"></i></a><a
                                    href="https://www.instagram.com/francesco_fuccilli/"><i
                                        class="fa fa-instagram"></i></a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-3 item" data-aos="fade-left" data-aos-duration="850">
                    <div class="box" style="background-image: url(&quot;assets/img/foto_claudio.jpg&quot;);">
                        <div class="cover">
                            ...
                            <p class="title">Developer</p>
                            <div class="social"><a href="https://www.facebook.com/claudio.lamusta"><i
                                        class="fa fa-facebook-official"></i></a><a
                                    href="https://www.instagram.com/claudiolamusta/"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <h1 class="text-center"
                        style="background-color: rgba(86,84,204,0.17);color: rgb(255,255,255);font-weight: bold;">
                ...
                <div class="col" style="padding-bottom: 70px;">
                    <div role="tablist" id="accordion-1">
                        <div class="card">
                            <div class="card-header text-center" role="tab">
                                <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false"
                                        aria-controls="accordion-1 .item-1" href="div#accordion-1 .item-1"
                                        style="color: rgb(0,0,0);">Cosa vuol dire essere un Cicerone?</a></h5>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header text-center" role="tab">
                                <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false"
                                        aria-controls="accordion-1 .item-2" href="div#accordion-1 .item-2"
                                        style="color: rgb(0,0,0);">Cosa vuol dire essere un Globetrotter?</a></h5>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header text-center" role="tab">
                                <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false"
                                        aria-controls="accordion-1 .item-3" href="div#accordion-1 .item-3"
                                        style="color: rgb(0,0,0);">Cosa si intende per attività?</a></h5>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header text-center" role="tab">
                                <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="false"
                                        aria-controls="accordion-1 .item-4" href="div#accordion-1 .item-4"
                                        style="color: rgb(0,0,0);">Come nasce il portale Cicerone?</a></h5>
                            </div>
